...
They do not provide energy, {% bubble (1), nor, yellow %} do they construct or build any part of the body. They are needed for {% bubble (2), transforming, yellow %} foods into energy and body maintenance. There are thirteen or more of them, and if {% bubble (3), any, yellow %} is missing a deficiency disease becomes {% bubble (4), apparent, yellow %}.

Vitamins are similar because they are made of the same elements—usually carbon, hydrogen, oxygen, and {% bubble (5), partially, yellow %} nitrogen. They are different {% bubble (6), in that, yellow %} their elements are arranged differently, and each vitamin {% bubble (7), undertakes, yellow %} one or more specific functions in the body.

{% bubble (8), Getting, yellow %} enough vitamins is essential to life, although the body has no nutritional use for {% bubble (9), excess, yellow %} vitamins. Many people, {% bubble (10), nevertheless, yellow %}, believe in being on the “safe side” and thus take extra vitamins. However, a wellbalanced diet will usually meet all the body’s vitamin needs.
...
| :------: | :----------: | :----------: | :-------: | :----------: |
|    1     |    either    |      so      |    nor    |    never     |
|    2     |   shifting   | transferring | altering  | transforming |
|    3     |     any      |     some     | anything  |  something   |
|    4     |   serious    |   apparent   |  severe   |    fatal     |
|    5     |    mostly    |  partially   | sometimes |    rarely    |
|    6     |   in that    |   so that    | such that | except that  |
|    7     |  undertakes  |    holds     |   plays   |   performs   |
|    8     |  Supplying   |   Getting    | Providing |  Furnishing  |
|    9     | exceptional  |  exceeding   |  excess   |   external   |
|    10    | nevertheless |  therefore   | moreover  |  meanwhile   |
...
It is a remarkable record, {% wavy stretching back over 70 years %} — yet the BBC’s future is now in doubt. The Corporation will survive as a publicly-funded broadcasting organization, at least for the time being, but its role, its size and its programmes are now the subject of a nation-wide debate in Britain.
...
{% wavy Economists have been particularly surprised by favourable inflation figures in Britain and the United States, since conventional measures suggest that both economies, and especially America’s, have little productive slack. %} America’s capacity utilisation, for example, hit historically high levels earlier this year, and its jobless rate (5.6% in August) has fallen below most estimates of the natural rate of unemployment— {% wavy the rate below which inflation has taken off in the past. %}
